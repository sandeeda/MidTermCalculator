...
public class MainActivity extends AppCompatActivity {
    ...
    public void operationClicked(View view) {
        ...
        //tvDetails.setText("");
        switch (view.getId()){
            case R.id.b_multiply: calculator.multiplyOperation(); break;
            case R.id.b_addition: calculator.addOperation(); break;
            case R.id.b_subtract: calculator.subtractOperation(); break;
            case R.id.b_div: calculator.divisionOperation(); break;
            case R.id.b_equal: calculator.resultOperation(); break;
        }
        updateCalcUI();
    }
}